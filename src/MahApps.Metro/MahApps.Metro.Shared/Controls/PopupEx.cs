...
namespace MahApps.Metro.Controls
{
    public class PopupEx : Popup
    {
        ...
        /// </summary>
        public static readonly DependencyProperty IsTopmostProperty = DependencyProperty.Register("IsTopmost", typeof(bool), typeof(PopupEx), new FrameworkPropertyMetadata(false, OnIsTopmostChanged));
